...
type IngestServiceClient interface {
	UpdateLocation(ctx context.Context, in *LocationUpdateRequest, opts ...grpc.CallOption) (*LocationUpdateResponse, error)
}
...
func (c *ingestServiceClient) UpdateLocation(ctx context.Context, in *LocationUpdateRequest, opts ...grpc.CallOption) (*LocationUpdateResponse, error) {
	out := new(LocationUpdateResponse)
	err := c.cc.Invoke(ctx, "/ingest.IngestService/UpdateLocation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IngestServiceServer interface {
	UpdateLocation(context.Context, *LocationUpdateRequest) (*LocationUpdateResponse, error)
...
func (UnimplementedIngestServiceServer) UpdateLocation(context.Context, *LocationUpdateRequest) (*LocationUpdateResponse, error) {
...
func _IngestService_UpdateLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LocationUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngestServiceServer).UpdateLocation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ingest.IngestService/UpdateLocation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServiceServer).UpdateLocation(ctx, req.(*LocationUpdateRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _IngestService_UpdateLocation_Handler,
		},
	},
